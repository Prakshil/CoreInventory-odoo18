      ...
      {step === 1 && (
        <form className="space-y-5" onSubmit={handleRequestOTP}>
          ...
          <button type="submit" disabled={loading}
            className={`w-full flex justify-center items-center py-3 px-4 rounded-xl shadow-md text-sm font-medium text-white bg-primary hover:bg-blue-700 transition-all ${loading ? 'opacity-70 cursor-not-allowed' : ''}`}>
            {loading ? (
